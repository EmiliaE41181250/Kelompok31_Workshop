...
$querylihat="SELECT id_nilaisupplier,kriteria.nama_kriteria AS nama_kriteria,nilai_kriteria.keterangan AS keterangan FROM nilai_supplier
    ...
    <div class="panel-middle">
        ...
        while($data2=$execute2->fetch_array(MYSQLI_ASSOC)){
            echo "<div class=\"group-input\">
                        <label for=\"\">$data2[nama_kriteria]</label>
